    ...
    ReRegExp.prototype.parse = function () {
                ...
                case s.translate:
                    ...
                    if (next === 'u' || next === 'x') {
                        ...
                        if (hasFlagU) {
                            ...
                            var matchedNum = target.untilEnd(context.slice(i));
                            if (matchedNum === 0) {
                                throw new Error("Invalid unicode category syntax at " + i + ": \\" + next);
                            }
                            else {
                                i += matchedNum;
                            }
                ...
                case s.leastOne:
                    target =
                        char === s.multipleBegin
                            ...
                            : new (RegexpTimesQuantifiers.bind.apply(RegexpTimesQuantifiers, __spreadArray([void 0], (this.config.maxRepeat ? [this.config.maxRepeat] : []))))();
        ...
        if (refOrNumbers.length) {
            var replace_1 = function (lists, search, rep) {
                ...
                if (finded) {
                    lists.splice.apply(lists, __spreadArray([idx, 1], rep));
                }
            };
